...
@interface TZPreviewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UIScrollViewDelegate> {
...
- (void)configCustomNaviBar {
    ...
    _selectButton.userInteractionEnabled = self.isCancelSelectPhoto;
