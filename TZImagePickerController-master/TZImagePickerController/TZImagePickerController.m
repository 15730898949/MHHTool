...
- (instancetype)initWithSelectedAssets:(NSMutableArray *)selectedAssets selectedPhotos:(NSMutableArray *)selectedPhotos index:(NSInteger)index{
    ...
    TZPreviewController *previewVc = [[TZPreviewController alloc]initWithPhotos:selectedPhotos currentIndex:index tzImagePickerVc:nil];
        ...
        [previewVc setDoneButtonClickBlock:^(NSArray *photos, BOOL isSelectOriginalPhoto) {
            ...
            [strongSelf dismissViewControllerAnimated:YES completion:^{
                ...
                if (strongSelf.didFinishPickingPhotosHandle) {
                    strongSelf.didFinishPickingPhotosHandle(photos,selectedAssets,isSelectOriginalPhoto);
                }
            }];
