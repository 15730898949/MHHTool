...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _videoImageView.image = MHPhotoViewImage(@"mh_photo_play");
...
- (void)layoutSubviews {
    ...
    _gifLable.frame = CGRectMake(self.bounds.size.width - 25, self.bounds.size.height - 14, 25, 14);
    
    CGFloat deleteWidth = self.bounds.size.width*0.3>36?36:self.bounds.size.width*0.3;
