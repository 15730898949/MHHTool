...
- (void)initSelf{
    ...
    self.buttomView = [[UIView alloc]initWithFrame:CGRectMake(10, kScreenHeight - 270, kScreenWidth - 20, 270)];
...
-(instancetype)initWithDateStyle:(WSDateStyle)datePickerStyle CompleteBlock:(void(^)(NSDate *))completeBlock {
    self = [super init];
    if (self) {
//        self = [[[NSBundle mainBundle] loadNibNamed:[NSString stringWithFormat:@"%@/%@",BUNDLE_PATH,NSStringFromClass([self class])] owner:self options:nil] lastObject];
