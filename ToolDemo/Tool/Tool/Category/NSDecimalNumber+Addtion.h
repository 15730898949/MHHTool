...
#define  handlerDecimalNumberPlain(number) handlerDecimalNumber(number, NSRoundPlain, 2)
#define  handlerDecimalNumberDown4(number) handlerDecimalNumber(number, NSRoundDown, 4)
