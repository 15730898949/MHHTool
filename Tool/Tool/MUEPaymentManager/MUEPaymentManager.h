...
#define MUPayAppDelegateName @"AppDelegate"
#define MUPayAlipayScheme @"tbopen30739234"
#define MUPayWXAPPID @"wxb4ac452ef8933cd5"
#define MUPayWXAppSecret @"ec97cf245d90c7b5fc0807d8714b08b2"
#define MUPayWXUniversalLink @"https://sdl66.cn/qq_conn/101898477/"
...
/**
 ...
 @param result 支付结果回调
 */
+ (void)muEPaymentManagerWithWeChatPay:(void(^)(PayReq * req))req result:(void(^)(PayResp * resp))result;
...
/**
 ...
 @param result 授权结果回调
 */
+ (void)muEPaymentManagerWithWeChatLogin:(void(^)(SendAuthReq * req))req controller:(UIViewController *)controller result:(void(^)(SendAuthResp * resp))result;
@end
