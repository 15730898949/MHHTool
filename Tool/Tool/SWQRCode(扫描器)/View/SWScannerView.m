...
- (UIImageView *)scannerLine {
    if (!_scannerLine) {
        ...
        _scannerLine.image = getBundleImage(@"ScannerLine");
    }
    return _scannerLine;
}
...
- (UIButton *)flashlightBtn {
    if (!_flashlightBtn) {
        ...
        [_flashlightBtn setBackgroundImage:getBundleImage(@"Flashlight_Off") forState:UIControlStateNormal];
        [_flashlightBtn setBackgroundImage:getBundleImage(@"Flashlight_On") forState:UIControlStateSelected];
    }
